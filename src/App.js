    ...
    <div className="App">
      <header className="hero-section">
        <nav className="navbar">
          <div className="logo">Yummy Yard</div>
        ...
        <div className="hero-content">
          ...
          <div className="rotating-picture">
            {/* You can add rotating pictures here */}
            {/* For example: */}
            <img
              src="https://playswellwithbutter.com/wp-content/uploads/2021/01/Cast-Iron-Steak-16-960x1440.jpg"
